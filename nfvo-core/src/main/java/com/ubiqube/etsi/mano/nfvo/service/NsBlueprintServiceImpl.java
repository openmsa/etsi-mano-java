...
public class NsBlueprintServiceImpl implements NsBlueprintService {
	...
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final Function<NsBlueprint, U> mapper, final String excludeDefaults, final Set<String> mandatoryFields, final Consumer<U> makeLink, final Class<U> frontClass) {
		final SearchParamBuilder<NsBlueprint, U> params = SearchParamBuilder.of(NsBlueprint.class, frontClass)
