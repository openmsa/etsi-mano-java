...
public class NfvoPmControllerImpl implements NfvoPmController {
	...
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final Function<PmJob, U> mapper, final String excludeDefaults, final Set<String> mandatoryFields, final Consumer<U> makeLink, final Class<U> frontClass) {
		final SearchParamBuilder<PmJob, U> params = SearchParamBuilder.of(PmJob.class, frontClass)
