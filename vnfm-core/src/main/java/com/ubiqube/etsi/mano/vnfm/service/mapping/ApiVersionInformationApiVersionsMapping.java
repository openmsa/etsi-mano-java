...
public interface ApiVersionInformationApiVersionsMapping {

	@Mapping(target = "isDeprecated", source = "deprecated")
	ApiVersionInformationApiVersions map(EtsiImplementation o);
}
