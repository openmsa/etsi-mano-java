 ...
 */
@JsonPropertyOrder({
		SearchResult.JSON_PROPERTY_CONTENT,
		SearchResult.JSON_PROPERTY_DISABLED,
		SearchResult.JSON_PROPERTY_NAME,
		SearchResult.JSON_PROPERTY_OBJECT_TYPE,
		SearchResult.JSON_PROPERTY_ZONE_ID,
		SearchResult.JSON_PROPERTY_ZONE,
		SearchResult.JSON_PROPERTY_TYPE,
		SearchResult.JSON_PROPERTY_TTL
})
...
public class SearchResult {
	...
	public SearchResult content(@Nullable final String content) {
	...
	public SearchResult disabled(@Nullable final Boolean disabled) {
	...
	public SearchResult name(@Nullable final String name) {
	...
	public SearchResult objectType(@Nullable final String objectType) {
	...
	public SearchResult zoneId(@Nullable final String zoneId) {
	...
	public SearchResult zone(@Nullable final String zone) {
	...
	public SearchResult type(@Nullable final String type) {
	...
	public SearchResult ttl(@Nullable final Integer ttl) {
