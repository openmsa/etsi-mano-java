...
public class SecurityGroupUow extends AbstractVnfmUow<SecurityGroupTask> {
	private final Vim vim;
	private final VimConnectionInformation vimConnectionInformation;
	private final SecurityGroupTask task;

	public SecurityGroupUow(final VirtualTaskV3<SecurityGroupTask> task, final Vim vim, final VimConnectionInformation vimConnectionInformation) {
