...
public class NsdPackageRepositoryService {
	...
	public NsdPackage findByNsdIdAndNsdOnboardingState(final String nsdId, final OnboardingStateType onboarded) {
		return nsdPackageJpa.findByNsdIdAndNsdOnboardingState(nsdId, onboarded);
	}

	public Optional<NsdPackage> findByNsdInvariantId(final String nsdId) {
		return nsdPackageJpa.findByNsdInvariantId(nsdId);
	}
