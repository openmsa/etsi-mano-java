...
public interface VnfPackageManagement {
	...
	<U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, Function<VnfPackage, U> mapper, String excludeDefaults, Set<String> mandatoryFields, Consumer<U> makeLink, Class<U> frontClass);
	...
	<U> ResponseEntity<String> searchOnboarded(MultiValueMap<String, String> requestParams, Function<VnfPackage, U> mapper, String excludeDefaults, Set<String> mandatoryFields, Consumer<U> makeLinks, Class<U> frontClass);
