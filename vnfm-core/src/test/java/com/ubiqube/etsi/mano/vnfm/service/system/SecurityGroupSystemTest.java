...
class SecurityGroupSystemTest {
	@Mock
	private Vim vim;
	@Mock
	private VimManager vimManager;
	@Mock
	private OrchestrationServiceV3<SecurityGroupTask> orch;
	@Mock
	private SystemBuilder<UnitOfWorkV3<SecurityGroupTask>> sys;

	@Test
	void test() {
		final SecurityGroupSystem srv = new SecurityGroupSystem(vim, vimManager);
		...
		when(orch.createEmptySystemBuilder()).thenReturn(sys);
