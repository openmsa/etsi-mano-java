...
public class PnfFrontControllerImpl implements PnfFrontController {
	 ...
	 */
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final Function<PnfDescriptor, U> mapper, final Consumer<U> makeLink, final Class<U> frontClass) {
