 ...
 * 1: The attributes \&quot;nsdIds\&quot;, \&quot;vnfdIds\&quot; and
 * \&quot;pnfdIds\&quot; are alternatives to reference to NS instances that are
 * created based on certain NSDs, or contain VNF instances that are based on
 * certain VNFDs, or contain PNFs that are based on certain PNFDs in a filter.
 * They should not be used together in the same filter instance, but one
 * alternative should be chosen. NOTE 2: The attributes
 * \&quot;nsInstanceIds\&quot; and \&quot;nsInstanceNames\&quot; are
 * alternatives to reference to particular NS Instances in a filter. They should
...
public class NsInstanceSubscriptionFilter {
	...
	public NsInstanceSubscriptionFilter nsdIds(final List<String> nsdIds) {
		this.nsdIds = nsdIds;
		return this;
	}

	public NsInstanceSubscriptionFilter addNsdIdsItem(final String nsdIdsItem) {
		if (this.nsdIds == null) {
	...
	/**
	 * If present, match NS instances that were created based on a NSD identified by
	 * one of the nsdId values listed in this attribute.
	 *
	 * @return nsdIds
	 **/
	...
	public void setNsdIds(final List<String> nsdIds) {
		this.nsdIds = nsdIds;
	}

	public NsInstanceSubscriptionFilter vnfdIds(final List<String> vnfdIds) {
		this.vnfdIds = vnfdIds;
		return this;
	}

	public NsInstanceSubscriptionFilter addVnfdIdsItem(final String vnfdIdsItem) {
	...
	/**
	 * If present, match NS instances that contain VNF instances that were created
	 * based on a VNFD identified by one of the vnfdId values listed in this
	 * attribute.
	 *
	 * @return vnfdIds
	 **/
	...
	public NsInstanceSubscriptionFilter pnfdIds(final List<String> pnfdIds) {
		this.pnfdIds = pnfdIds;
		return this;
	}

	public NsInstanceSubscriptionFilter addPnfdIdsItem(final String pnfdIdsItem) {
	...
	/**
	 * If present, match NS instances that contain PNFs that are represented by a
	 * PNFD identified by one of the pnfdId values listed in this attribute.
	 *
	 * @return pnfdIds
	 **/
	...
	public void setPnfdIds(final List<String> pnfdIds) {
		this.pnfdIds = pnfdIds;
	}

	public NsInstanceSubscriptionFilter nsInstanceIds(final List<String> nsInstanceIds) {
		this.nsInstanceIds = nsInstanceIds;
		return this;
	}

	public NsInstanceSubscriptionFilter addNsInstanceIdsItem(final String nsInstanceIdsItem) {
	...
	/**
	 * If present, match NS instances with an instance identifier listed in this
	 * attribute.
	 *
	...
	public void setNsInstanceIds(final List<String> nsInstanceIds) {
		this.nsInstanceIds = nsInstanceIds;
	}

	public NsInstanceSubscriptionFilter nsInstanceNames(final List<String> nsInstanceNames) {
		this.nsInstanceNames = nsInstanceNames;
		return this;
	}

	public NsInstanceSubscriptionFilter addNsInstanceNamesItem(final String nsInstanceNamesItem) {
	...
	/**
	 * If present, match NS instances with a NS Instance Name listed in this
	 * attribute.
	 *
	...
	public void setNsInstanceNames(final List<String> nsInstanceNames) {
		this.nsInstanceNames = nsInstanceNames;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		final NsInstanceSubscriptionFilter nsInstanceSubscriptionFilter = (NsInstanceSubscriptionFilter) o;
