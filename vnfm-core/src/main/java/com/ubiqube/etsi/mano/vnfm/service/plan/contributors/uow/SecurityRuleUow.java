...
public class SecurityRuleUow extends AbstractVnfmUow<SecurityRuleTask> {
	private final Vim vim;
	private final VimConnectionInformation vimConnectionInformation;
	private final SecurityRuleTask task;

	public SecurityRuleUow(final VirtualTaskV3<SecurityRuleTask> task, final Vim vim, final VimConnectionInformation vimConnectionInformation) {
