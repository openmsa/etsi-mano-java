...
public class NsDescriptorGenericFrontControllerImpl implements NsDescriptorGenericFrontController {
	 ...
	 */
	@Override
	public <U> ResponseEntity<String> search(@RequestParam final MultiValueMap<String, String> requestParams, final Function<NsdPackage, U> mapper, final Consumer<U> makeLink, final Class<U> frontClass) {
		return nsdController.search(requestParams, mapper, NSD_SEARCH_DEFAULT_EXCLUDE_FIELDS, NSD_SEARCH_MANDATORY_FIELDS, makeLink, frontClass);
	}
