...
public class AlarmFrontControllerImpl implements AlarmFrontController {
	...
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final Function<Alarms, U> mapper, final Consumer<U> makeLink, final Class<U> frontClass) {
