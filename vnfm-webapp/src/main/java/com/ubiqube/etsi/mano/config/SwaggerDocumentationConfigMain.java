...
public class SwaggerDocumentationConfigMain {
	...
	OpenAPI openApiMain(final ManoProperties oauth2Params) {
		...
		openApi.info(new Info().title("ETSI Main VNFM API")
				.description("ETSI MANO SOL002 & SOL003 API")
	...
	GroupedOpenApi customImplementationMain() {
		return GroupedOpenApi.builder()
				.group("main")
				.packagesToScan("com.ubiqube.etsi.mano.controller", "com.ubiqube.etsi.mano.vnfm.controller")
				.build();
	}
}
