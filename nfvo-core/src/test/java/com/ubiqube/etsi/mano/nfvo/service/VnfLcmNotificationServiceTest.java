...
import com.ubiqube.etsi.mano.nfvo.service.repository.VnfLcmNotificationRepositoryService;
...
class VnfLcmNotificationServiceTest {
	@Mock
	private RemoteSubscriptionRepositoryService remoteSubscription;
	@Mock
	private VnfLcmNotificationRepositoryService vnfLcmJpa;

	@Test
	void testOnCreationNotification() {
	...
	@Test
	void testOnDeletionNotification() {
		final VnfLcmNotificationService srv = new VnfLcmNotificationService(remoteSubscription, vnfLcmJpa);
		final VnfLcmNotification evt = new VnfLcmNotification();
		final RemoteSubscription rmt = new RemoteSubscription();
		when(remoteSubscription.findByRemoteSubscriptionId(any())).thenReturn(List.of(rmt));
	...
	@Test
	void testOnVnfLcmOpOccsNotification() {
		final VnfLcmNotificationService srv = new VnfLcmNotificationService(remoteSubscription, vnfLcmJpa);
		final VnfLcmNotification evt = new VnfLcmNotification();
		final RemoteSubscription rmt = new RemoteSubscription();
		when(remoteSubscription.findByRemoteSubscriptionId(any())).thenReturn(List.of(rmt));
	...
	@Test
	void testOnVnfLcmOpOccsNotificationNotFound() {
		final VnfLcmNotificationService srv = new VnfLcmNotificationService(remoteSubscription, vnfLcmJpa);
		final VnfLcmNotification evt = new VnfLcmNotification();
