...
import com.ubiqube.etsi.mano.nfvo.service.repository.AlarmNotificationRepositoryService;
...
public class VnffmNotificationService {
	...
	private final AlarmNotificationRepositoryService vnfFmJpa;

	public VnffmNotificationService(final RemoteSubscriptionRepositoryService remoteSubscriptionJpa, final AlarmNotificationRepositoryService vnfFmJpa) {
