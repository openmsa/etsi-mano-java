 ...
 */
@Service
public class NsScaleStrategyV3 {

	private static final Logger LOG = LoggerFactory.getLogger(NsScaleStrategyV3.class);

	public int getNumberOfInstances(final NsdVnfPackageCopy nsPackageVnfPackage, final NsBlueprint blueprint) {
