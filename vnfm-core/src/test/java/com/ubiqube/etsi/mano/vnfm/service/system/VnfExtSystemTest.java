...
class VnfExtSystemTest {
	@Mock
	private VimManager vimManager;
	@Mock
	private Vim vim;
	@Mock
	private OrchestrationServiceV3<ExternalCpTask> orch;

	@Test
	void test() {
		final VnfExtSystem srv = new VnfExtSystem(vim, vimManager);
		final VimConnectionInformation vimConn = new VimConnectionInformation();
		final ExternalCpTask nt = new ExternalCpTask();
