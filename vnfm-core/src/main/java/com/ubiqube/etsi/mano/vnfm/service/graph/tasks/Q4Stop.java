...
public class Q4Stop implements Q4Task {
	private final String resourceId;
	private final Vim vim;
	private final VimConnectionInformation vimConnectionInformation;

	public Q4Stop(final String resourceId, final Vim vim, final VimConnectionInformation vimConnectionInformation) {
	...
	public String execute(final Q4Context context3d) {
		vim.stopServer(vimConnectionInformation, resourceId);
		return null;
	}
