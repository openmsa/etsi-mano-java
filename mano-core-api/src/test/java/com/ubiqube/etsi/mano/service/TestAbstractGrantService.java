...
public class TestAbstractGrantService extends AbstractGrantService {
	...
	protected TestAbstractGrantService(final ResourceAllocate nfvo, final VimManager vimManager, final ConnectionInformationRepositoryService connectionJpa, final BlueZoneGroupInformationMapping blueZoneGroupInformationMapping,
