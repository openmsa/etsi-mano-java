...
class VnfmActionsControllerImplTest {
	@Mock
	private VnfmActionController actionController;

	@Test
	void test() {
		final VnfmActionsControllerImpl srv = new VnfmActionsControllerImpl(actionController);
