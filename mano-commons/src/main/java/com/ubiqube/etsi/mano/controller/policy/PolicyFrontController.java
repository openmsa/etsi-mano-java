...
public interface PolicyFrontController {
	...
	<U> ResponseEntity<String> search(MultiValueMap<String, String> requestParams, String nextpageOpaqueMarker, Function<Policies, U> mapper, Consumer<U> makeLinks, Class<U> frontClass);
