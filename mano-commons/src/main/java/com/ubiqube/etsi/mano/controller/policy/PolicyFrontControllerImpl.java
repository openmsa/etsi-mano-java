...
public class PolicyFrontControllerImpl implements PolicyFrontController {
	...
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker, final Function<Policies, U> mapper, final Consumer<U> makeLinks, final Class<U> frontClass) {
