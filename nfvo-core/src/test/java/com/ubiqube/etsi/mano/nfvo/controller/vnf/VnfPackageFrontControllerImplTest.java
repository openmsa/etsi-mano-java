...
class VnfPackageFrontControllerImplTest {
	...
	void testGetArtifactPath() throws Exception {
		final VnfPackageFrontControllerImpl srv = new VnfPackageFrontControllerImpl(vnfPkgMng, vnfPackageController);
