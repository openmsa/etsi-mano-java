...
import com.ubiqube.etsi.mano.nfvo.service.repository.NetworksRepositoryService;

@ExtendWith(MockitoExtension.class)
class IpamServiceTest {
	@Mock
	private NetworksRepositoryService networksJpa;

	@Test
	void testNetworkNotFound() {
		final IpamService ip = new IpamService(networksJpa);
		final VimConnectionInformation conn = new VimConnectionInformation();
		final BiFunction<VimConnectionInformation, Networks, String> func = (x, y) -> null;
