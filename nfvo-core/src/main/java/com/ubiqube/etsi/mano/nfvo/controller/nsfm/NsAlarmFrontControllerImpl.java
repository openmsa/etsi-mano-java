...
public class NsAlarmFrontControllerImpl implements NsAlarmFrontController {
	...
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final String nextpageOpaqueMarker, final Function<Alarms, U> mapper, final Consumer<U> makeLinks, final Class<U> frontClass) {
