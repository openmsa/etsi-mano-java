...
public class VnfmPmGenericFrontControllerImpl implements VnfmPmGenericFrontController {
	...
	@Override
	public <U> ResponseEntity<String> search(final MultiValueMap<String, String> requestParams, final Function<PmJob, U> mapper, final Consumer<U> makeLink, final Class<U> frontClass) {
