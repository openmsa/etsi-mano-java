...
class MonitoringSystemTest {
	@Mock
	private VnfMonitoringService monitoringService;
	@Mock
	private VimManager vimManager;
	@Mock
	private OrchestrationServiceV3<MonitoringTask> orchService;

	@Test
	void test() {
		final MonitoringSystem srv = new MonitoringSystem(monitoringService, vimManager);
		final MonitoringTask nt = new MonitoringTask();
		final VirtualTaskV3<MonitoringTask> vt = new MonitoringVt(nt);
